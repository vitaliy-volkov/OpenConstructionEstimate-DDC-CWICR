...
<div align="center">
  ...
  <img src="https://img.shields.io/badge/语言-11-d97706?style=for-the-badge" alt="Languages">
  <img src="https://img.shields.io/badge/国家-12+-dc2626?style=for-the-badge" alt="Countries">
</div>
...
## 🎯 DDC Skills — 196个即用型AI自动化

> **新功能！** [建筑行业AI代理的DDC Skills](https://github.com/datadrivenconstruction/DDC_Skills_for_AI_Agents_in_Construction) — 建筑公司的完整自动化工具包。
...
```
1. 克隆Skills仓库
2. 使用Claude Code、Cursor或GitHub Copilot打开
3. 描述您想要自动化的内容 — AI将逐步指导您
```
...
| 文件夹 | Skills | 描述 |
|--------|--------|------|
| **DDC Toolkit** | 85 | 包含CWICR数据库集成的生产工具 |
| **DDC Book** | 50 | 基于Data-Driven Construction方法论的技能 |
| **DDC Insights** | 5 | n8n工作流模板 |
| **DDC Curated** | 5 | 外部集成技能 |
| **DDC Innovative** | 22 | 高级AI/ML功能 |

Skills仓库提供**与此CWICR数据库的直接集成** — 语义搜索、自动成本计算、日报、缺陷检测等。

**→ [开始使用DDC Skills](https://github.com/datadrivenconstruction/DDC_Skills_for_AI_Agents_in_Construction)**
...
<p align="center">
  <a href="https://buildcalculator.io/api-docs/">
    <img src="https://img.shields.io/badge/API_文档-buildcalculator.io-2563eb?style=for-the-badge" alt="API Docs">
  </a>
  &nbsp;
  <img src="https://img.shields.io/badge/认证-无需认证-059669?style=for-the-badge" alt="No Auth">
  &nbsp;
  <img src="https://img.shields.io/badge/费用-免费-059669?style=for-the-badge" alt="Free">
  &nbsp;
  <img src="https://img.shields.io/badge/速率限制-60_次/分钟-d97706?style=for-the-badge" alt="Rate Limit">
</p>

免费的 REST API，用于搜索建筑工程项目，提供完整的成本分解、人工、材料和设备数据。**55,719 个项目**，支持 **11 种语言**，每个项目包含 **84 个字段**。

**基础 URL：** `https://buildcalculator.io/api/v1`
...
**cURL：**
```bash
curl "https://buildcalculator.io/api/v1/search?q=混凝土基础&lang=zh&top=5"
```
...
const res = await fetch(
  "https://buildcalculator.io/api/v1/search?q=屋顶覆盖&lang=zh&top=3"
);
...
| 代码 | 含义 | 操作 |
|------|------|------|
| 400 | 查询缺失或无效 | 检查 `q` 参数（最少2个字符） |
| 429 | 超出速率限制 | 等待后重试（60 次/分钟） |
| 500 | 服务器错误 | 重试或联系支持 |

> 📖 完整文档：[buildcalculator.io/api-docs](https://buildcalculator.io/api-docs/)
...
`AI_INSTRUCTIONS/` 文件夹包含 AI 编程助手有效使用此建筑成本数据库的完整文档。
...
工作流展示：数据库查询、工作项目匹配、区域定价逻辑和报告生成。AI 可以分析这些来理解完整的估算过程。
...
**书籍**: 方法论详情请参阅 [Data-Driven Construction 书籍](https://datadrivenconstruction.io/book)
...
Autodesk®、Revit®、AutoCAD® 和 DWG™ 是 Autodesk, Inc. 的注册商标或商标。OpenAI™ 是 OpenAI, Inc. 的商标。Qdrant 是 Qdrant Solutions GmbH 的商标。所有其他品牌名称、产品名称或商标均归其各自所有者所有。

本项目与 Autodesk、OpenAI、Qdrant 或上述任何其他商标持有者没有关联、认可或赞助关系。
